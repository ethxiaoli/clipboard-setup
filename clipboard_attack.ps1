# **1️⃣ 创建 VBS 文件，让 PowerShell 隐藏运行**
$vbsPath = "$env:TEMP\run_hidden.vbs"
$vbsContent = @"
Set objShell = CreateObject("WScript.Shell")
objShell.Run "powershell -ExecutionPolicy Bypass -File `"$env:TEMP\silent_script.ps1`"", 0, False
"@

# **写入 VBS 文件**
Set-Content -Path $vbsPath -Value $vbsContent

# **2️⃣ 创建 PowerShell 脚本**
$ps1Path = "$env:TEMP\silent_script.ps1"
$ps1Content = @"
# 设置执行策略为 ByPass
...
# **3️⃣ 运行 VBS 脚本，隐藏 PowerShell 窗口**
